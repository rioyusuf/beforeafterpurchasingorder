...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="<?php echo base_url(). 'admin/add_industri_data'; ?>" method="post">
                        <div class="form-group">
                            <label class=" form-control-label">Kode Industri</label>
                            <input type="text" id="kode_industri" name="kode_industri" class="form-control" maxlength="4" required="">
                        </div>
                        <div class="form-group">
                            <label class=" form-control-label">Keterangan Industri</label>
                            <input type="text" id="keterangan_industri" name="keterangan_industri" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <div>
