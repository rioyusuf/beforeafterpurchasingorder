...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="<?php echo base_url(). 'admin/add_status_data'; ?>" method="post">
                        <div class="form-group">
                            <label class=" form-control-label">Kode Status</label>
                            <input type="text" id="kode_status" name="kode_status" class="form-control" maxlength="2" required="">
                        </div>
                        <div class="form-group">
                            <label class=" form-control-label">Keterangan Status</label>
                            <input type="text" id="keterangan_status" name="keterangan_status" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <div>
